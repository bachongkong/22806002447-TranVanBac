...
// ============================================
// HOMEPAGE - Recruitment Platform Design System
                ...
                >
                    ...
                    >
                        <p className="text-lg md:text-xl text-[#637381] dark:text-[#C4CDD5] font-normal leading-relaxed">
                            Recruitment Platform - Trợ lý AI tuyển dụng cá nhân của bạn.
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-[#637381] dark:text-[#C4CDD5] text-lg max-w-2xl mx-auto">
                        Để Recruitment Platform lo việc tìm kiếm, bạn tập trung vào điều quan trọng nhất - sự nghiệp của mình.
                    </p>
                </motion.div>
    ...
    const testimonials = [
        {
            ...
            quote: "Tôi dành 2 tiếng mỗi tối để nộp đơn xin việc. Recruitment Platform đã trả lại những buổi tối cho gia đình tôi.",
            stats: "275 công việc • 14 phỏng vấn • 8 tuần nhận offer"
        },
        {
            name: "Sarah",
            role: "Full-Stack Developer",
            quote: "Recruitment Platform lo việc nộp đơn trong khi tôi tập trung vào dự án. Khi có phỏng vấn, tôi đã sẵn sàng.",
            stats: "Tập trung học tập • Nhận công việc mơ ước • Không kiệt sức"
        },
        {
            name: "Minh",
            role: "Fulfillment Associate",
            quote: "Thiết lập Recruitment Platform và bây giờ nó nộp đơn trong giờ làm việc trong khi tôi ngủ hoặc làm việc. Thay đổi cuộc chơi!",
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-gray-400 text-lg mb-8 max-w-xl mx-auto">
                            Tham gia cùng hàng nghìn ứng viên đã tìm được thành công với Recruitment Platform.
                        </p>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="md:col-span-1">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            <span className="text-white font-bold text-xl tracking-tight">Recruitment Platform</span>
                        </Link>
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-white/40 text-sm">
                        © 2026 Recruitment Platform. All rights reserved.
                    </p>
